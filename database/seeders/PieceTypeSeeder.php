...
class PieceTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        $pieceTypes = [
            ...
            ['name' => 'Codo Radial con salida recta v2', 'image_path' => '/png/pieces/codo_radial_salida_recta.png', 'measurements' => array('Ancho izquierdo',
            'Ancho superior', 'Ancho inferior', 'Profundo', 'Extensión izquierda', 'Extensión inferior', 'Alto', 'Radio interno', 'Angulo')],
            ...
            ['name' => 'Ramas rectangualres v2', 'image_path' => '/png/pieces/ramas_rectangulares.png', 'measurements' => array('Ancho inferior', 'Extensión inferior', 'Ancho izquierdo', 'Extensión izquierda',
            'Radio izquierdo', 'Ancho derecho', 'Extensión derecha', 'Radio derecho', 'Profundo')],
            ...
            ['name' => 'División triple v2', 'image_path' => '/png/pieces/division_triple.png', 'measurements' => array('Ancho inferior', 'Extensión inferior', 'Ancho izquierdo', 'Extensión izquierda',
            'Radio izquierdo', 'Ángulo izquierdo', 'Ancho derecho', 'Extensión derecha', 'Radio derecho', 'Ángulo derecho', 'Ancho central', 'Altura central', 'Profundo')],
